...
try{
  ...
  for(const name of [...Object.keys(data.recipeHashes),'model-source/storefront-details.json','model-source/seventh-street-reference-02.json','model-source/west-seventh-reference-04.json','model-source/west-seventh-observations-04.json','model-source/make_seventh_audio.py','scripts/export-seventh.mjs']){
