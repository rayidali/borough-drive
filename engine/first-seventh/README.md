...
**Current local revision 07:** browser references refine the First Avenue–Avenue A block, including observed number placements, individual entrances/shops, projecting oriels, dated scaffolds, corner rhythms and the 108 gated street edge. [Current report and evidence](../../model-source/SEVENTH-ENGINE-07.md). Original game, west block, accepted corner, UI and audio remain protected. The candidate is local, with no photographic 1:1 acceptance or publication. Read the [handoff](../../CODEX-HANDOFF.md) for actual validation and saved state.
