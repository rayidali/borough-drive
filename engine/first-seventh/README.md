...
**Current local revision 06:** the First Avenue–Avenue A block is implemented as a public-reference candidate with 33 changed building models, two newly scheduled church profiles (78 explicit / four preserved Seventh elevations total), corrected addresses and distinct shop/entry/corner details. [East-block report and evidence](../../model-source/SEVENTH-ENGINE-06.md). The west block, accepted corner, UI and audio are preserved; no publication or calibrated 1:1 acceptance is claimed. The 108 site and current street-fixture details remain evidence gaps. Read the [handoff](../../CODEX-HANDOFF.md) for actual saved and published states.
