...
## Seventh architectural fidelity revision 03 — September 14, 2026

Current inspection includes April 2026 and September 2024 Google Street View panoramas and a private user comparison screenshot. `storefront-details.json.seventhEngine.sources` preserves panorama IDs, dates, camera metadata, source links and limits; source images and unrelated screenshot content are not distributed. The [June 11, 2026 Middle Church House exterior report](https://daytoninmanhattan.blogspot.com/2026/06/the-1892-middle-church-house-50-east.html) includes photographs credited to Carole Teller, inspected for the current lowered oak entrances at 50 East 7th. CTA Architects and the January 2024 NYC CB3 presentation were used as project/site context, not as present-day door photographs.

The revised geometry and shallow decorative relief remain authored interpretations, with estimated dimensions and substitute typefaces. No new photographic texture or exact changing poster artwork is included. The [fidelity contract](model-source/SEVENTH-FIDELITY-BENCHMARK.md) and [revision report](model-source/SEVENTH-ENGINE-03.md) distinguish observations, model corrections and pending visual acceptance. All existing credits and licenses above remain applicable.

## September 21 interface typography

The Seventh interface bundles unmodified Inter 4.1 TTF and WOFF2 from the [official Inter release](https://github.com/rsms/inter/releases/tag/v4.1), copyright 2016 The Inter Project Authors, under the SIL Open Font License 1.1. [License](engine/first-seventh/assets/fonts/INTER-OFL.txt) and [source hashes](engine/first-seventh/assets/fonts/SOURCES.md) are included; the browser export distributes `INTER-OFL.txt`. The supplied DriveAround.nyc logo is retained unchanged as the user's brand asset. Private reference screenshots are not included in the interface or export.
