...
September 23, 2026. **Implemented and reviewed locally; not published.** Scope is both sides of East 7th Street from First Avenue to Avenue A: 35 editable frontage records, two protected First Avenue corner records and the 108 street edge. The user explicitly requested ordinary browser Street View observation and address numbers in their observed positions. No publication is requested.
...
There are **zero calibrated multi-view acceptance passes**. Source inspection, readable numbers, structural verification and a successful export do not establish photographic 1:1 or surveyed accuracy. Revision 04 remains the user-endorsed visual direction; revision 07 is a locally reviewable refinement. Read the [current handoff](../CODEX-HANDOFF.md) for exact Git, test and publication states.
