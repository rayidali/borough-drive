...
**Current local revision 07 — East 7th, First Avenue to Avenue A:** browser Street View observations cover all 37 frontage records, with explicit door/number/shop/window corrections and the 108 gated street edge. [Current report and review state](model-source/SEVENTH-ENGINE-07.md); [exact save/test/push state](CODEX-HANDOFF.md). This candidate is local, not published or certified 1:1.
