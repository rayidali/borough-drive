...
**Current local revision 06 — East 7th, First Avenue to Avenue A:** both sides received a public-reference architectural pass, with 33 changed models across 35 editable and two protected frontages. Corrections include individual opening/access layouts, St Stanislaus and former St Mary, McKinley, Mary O's and the Avenue A corner returns. The address HUD now covers Second Avenue through Avenue A. [Report, captures and remaining gaps](model-source/SEVENTH-ENGINE-06.md); [exact save/push state](CODEX-HANDOFF.md). This pass is not published or certified 1:1. The 108 site and some current street/occluded details still need evidence.
