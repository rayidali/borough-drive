...
- Latest September 10 direction: prioritize smooth browser play, defer Unreal, refine First & 7th and prepare the bounded block workflow in `model-source/BLOCK-WORKFLOW.md`. Use the current corner as the working visual reference. Offline packets and inventory do not authorize paid batch submission, source-rights assumptions, automatic acceptance or publication. Keep the protected core and all existing provenance.
